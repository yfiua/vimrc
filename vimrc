...
Plugin 'yfiua/vim-nerdtree-tabs'
Plugin 'Xuyuanp/nerdtree-git-plugin'

" Airline
Plugin 'vim-airline/vim-airline'

" Plugin for language supports
...
" Set the delay before VIM writes its swap file
set updatetime=200
...
" => VIM user interface
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
" Show the path and filename in the terminal title
" set title titlestring=%(%{expand(\"%:~:.:h\")}%)/%t\ -\ Vim

" Show the filename in the terminal title
...
" Disable foldcolumn, instead use signcolumn
set foldcolumn=0
set signcolumn=yes
...
map <leader>su :setlocal spell spelllang=en_us<cr>
map <leader>sg :setlocal spell spelllang=en_gb<cr>

" Fix the last mistake using the first suggestion with <C-l>
